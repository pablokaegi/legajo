import { N as NuevaActaSchema, c as crearActa } from './actas-9WOqR55x.js';
...
var load = async ({ locals }) => {
	...
	const { listarCursosPreceptoria } = await import('./cursos-IR8gMv_v.js');
	return { cursos: await listarCursosPreceptoria().catch(() => []) };
};
...
const index = 28;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-DKf-NnYr.js')).default;
const server_id = "src/routes/preceptor/actas/nueva/+page.server.ts";
const imports = ["_app/immutable/nodes/28.DQvwmXZk.js","_app/immutable/chunks/BwH-sKw0.js","_app/immutable/chunks/DHMuKLC9.js","_app/immutable/chunks/BK0LEZXi.js","_app/immutable/chunks/DTn0QNcA.js","_app/immutable/chunks/BEDIq91W.js"];
const stylesheets = [];
const fonts = [];

export { component, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=28-DQy_5sv3.js.map

...
var actions = { default: async ({ request, locals }) => {
	if (!locals.usuario) throw redirect(303, "/auth");
	if (!await esPreceptorODirectivo(locals.usuario.usuarioId)) error(403, "No tenés permiso para crear efemérides.");
...
const imports = ["_app/immutable/nodes/23.iMqIVjKD.js","_app/immutable/chunks/DW4Xyvmx.js","_app/immutable/chunks/Q94VlVm2.js"];
const stylesheets = [];
const fonts = [];

export { component, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=23-CC0CCy0K.js.map

...
const index = 12;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-zoKmbYkz.js')).default;
const server_id = "src/routes/preceptor/actas/+page.server.ts";
const imports = ["_app/immutable/nodes/12.CVN7gvUP.js","_app/immutable/chunks/BCmZRGrY.js","_app/immutable/chunks/2TU3FloQ.js"];
const stylesheets = [];
const fonts = [];

export { component, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=12-BuF2aX-V.js.map

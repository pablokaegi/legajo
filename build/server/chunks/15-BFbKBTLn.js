...
const index = 15;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-BAE-SjT2.js')).default;
const server_id = "src/routes/preceptor/amonestaciones/+page.server.ts";
const imports = ["_app/immutable/nodes/15.338aRQ02.js","_app/immutable/chunks/BCmZRGrY.js","_app/immutable/chunks/2TU3FloQ.js"];
const stylesheets = [];
const fonts = [];

export { component, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=15-BFbKBTLn.js.map

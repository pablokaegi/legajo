...
const index = 17;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-DLXKg8vU.js')).default;
const server_id = "src/routes/preceptor/faltas/+page.server.ts";
const imports = ["_app/immutable/nodes/17.CfCcKMns.js","_app/immutable/chunks/98Yg7eFK.js","_app/immutable/chunks/2TU3FloQ.js"];
const stylesheets = [];
const fonts = [];

export { component, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=17-DdCUPpgM.js.map

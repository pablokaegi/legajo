...
import { D as DevalueError, x as is_primitive, y as get_type, z as is_plain_object, A as enumerable_symbols, B as stringify_key, C as stringify_string, E as valid_array_indices, F as render, G as set, L as LEGACY_PROPS, H as get, I as flushSync, J as define_property, K as mutable_source, M as init_operations, N as get_first_child, O as get_next_sibling, P as HYDRATION_ERROR, Q as set_hydrating, R as set_hydrate_node, S as hydration_failed, T as clear_text_content, U as component_root, V as hydrate_node, W as create_text, X as boundary, Y as array_from, Z as is_passive_event, _ as set_active_reaction, $ as set_active_effect, a0 as active_reaction, a1 as active_effect, j as setContext, d as derived, a2 as hydrating, a3 as push, a4 as component_context, a5 as hydration_mismatch, a6 as pop } from './dev-BsmPEhme.js';
...
var options = {
	...
	templates: {
		app: ({ head, body, assets, nonce, env }) => "<!doctype html>\n<html lang=\"es\">\n  <head>\n    <meta charset=\"utf-8\" />\n    <link rel=\"icon\" href=\"/logo-pds.png\" type=\"image/png\" />\n    <link rel=\"apple-touch-icon\" href=\"/logo-pds.png\" />\n    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n    <meta name=\"theme-color\" content=\"#4f46e5\" />\n    <link rel=\"manifest\" href=\"/manifest.json\" />\n    " + head + "\n  </head>\n  <body data-sveltekit-preload-data=\"hover\">\n    <div style=\"display: contents\">" + body + "</div>\n  </body>\n</html>\n",
		error: ({ status, message }) => "<!doctype html>\n<html lang=\"en\">\n	<head>\n		<meta charset=\"utf-8\" />\n		<title>" + message + "</title>\n\n		<style>\n			body {\n				--bg: white;\n				--fg: #222;\n				--divider: #ccc;\n				background: var(--bg);\n				color: var(--fg);\n				font-family:\n					system-ui,\n					-apple-system,\n					BlinkMacSystemFont,\n					'Segoe UI',\n					Roboto,\n					Oxygen,\n					Ubuntu,\n					Cantarell,\n					'Open Sans',\n					'Helvetica Neue',\n					sans-serif;\n				display: flex;\n				align-items: center;\n				justify-content: center;\n				height: 100vh;\n				margin: 0;\n			}\n\n			.error {\n				display: flex;\n				align-items: center;\n				max-width: 32rem;\n				margin: 0 1rem;\n			}\n\n			.status {\n				font-weight: 200;\n				font-size: 3rem;\n				line-height: 1;\n				position: relative;\n				top: -0.05rem;\n			}\n\n			.message {\n				border-left: 1px solid var(--divider);\n				padding: 0 0 0 1rem;\n				margin: 0 0 0 1rem;\n				min-height: 2.5rem;\n				display: flex;\n				align-items: center;\n			}\n\n			.message h1 {\n				font-weight: 400;\n				font-size: 1em;\n				margin: 0;\n			}\n\n			@media (prefers-color-scheme: dark) {\n				body {\n					--bg: #222;\n					--fg: #ddd;\n					--divider: #666;\n				}\n			}\n		</style>\n	</head>\n	<body>\n		<div class=\"error\">\n			<span class=\"status\">" + status + "</span>\n			<div class=\"message\">\n				<h1>" + message + "</h1>\n			</div>\n		</div>\n	</body>\n</html>\n"
	},
	version_hash: "1ez6jek"
};
async function get_hooks() {
	...
	let init;
	({handle, handleFetch, handleError, handleValidationError, init} = await import('./hooks.server-D2sTWlgL.js'));
	let reroute;
	let transport;
	return {
		handle,

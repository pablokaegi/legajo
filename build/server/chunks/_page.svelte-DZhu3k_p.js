import { R as head, T as ensure_array_like, V as attr_class, S as escape_html, U as attr, W as stringify, K as derived } from './dev-BjcCn9Qu.js';
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		let alumnos = [];
		let seleccionados = preselectSingle ? new Set([data.preselect.alumnoId]) : /* @__PURE__ */ new Set();
		let alumnosNombres = preselectSingle ? new Map([[data.preselect.alumnoId, data.preselect.alumnoNombre ?? ""]]) : /* @__PURE__ */ new Map();
...
//# sourceMappingURL=_page.svelte-DZhu3k_p.js.map

...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		let busqueda = "";
		let filtroGravedad = "";
		const listaFiltrada = derived(() => data.lista.filter((a) => {
			const q = busqueda.trim().toLowerCase();
			return (!q || a.alumnoNombre.toLowerCase().includes(q) || (a.cursoNombre ?? "").toLowerCase().includes(q)) && true;
		}));
...
//# sourceMappingURL=_page.svelte-BGt767y6.js.map

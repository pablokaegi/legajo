...
var actions = { default: async ({ request, locals }) => {
	if (!locals.usuario) throw redirect(303, "/auth");
	if (!await esPreceptorODirectivo(locals.usuario.usuarioId)) error(403, "No tenés permiso para crear salidas.");
...
const imports = ["_app/immutable/nodes/26.BiJGEDyL.js","_app/immutable/chunks/DW4Xyvmx.js","_app/immutable/chunks/Q94VlVm2.js"];
const stylesheets = [];
const fonts = [];

export { component, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=26-B-N0q5k1.js.map

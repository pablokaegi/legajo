...
import { e as eliminarEfemeride, a as editarEfemeride, o as obtenerEfemeride } from './efemerides-yYiAprvC.js';
...
var actions = {
	editar: async ({ request, locals, params }) => {
		if (!locals.usuario) throw redirect(303, "/auth");
		if (!await esPreceptorODirectivo(locals.usuario.usuarioId)) error(403, "No tenés permiso para editar efemérides.");
		const id = parseInt(params.id, 10);
	...
	eliminar: async ({ locals, params }) => {
		if (!locals.usuario) throw redirect(303, "/auth");
		if (!await esPreceptorODirectivo(locals.usuario.usuarioId)) error(403, "No tenés permiso para eliminar efemérides.");
...
const imports = ["_app/immutable/nodes/24.B08uzblx.js","_app/immutable/chunks/DW4Xyvmx.js","_app/immutable/chunks/Q94VlVm2.js"];
const stylesheets = [];
const fonts = [];

export { component, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=24-29_Jfh2X.js.map

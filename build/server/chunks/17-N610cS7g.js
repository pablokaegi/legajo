...
const index = 17;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-DoYpfqqL.js')).default;
const server_id = "src/routes/preceptor/faltas/+page.server.ts";
const imports = ["_app/immutable/nodes/17.CxjlfY1z.js","_app/immutable/chunks/CioMSKJw.js","_app/immutable/chunks/CuyqONxg.js"];
const stylesheets = [];
const fonts = [];

export { component, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=17-N610cS7g.js.map

import { l as esPreceptorODirectivo } from './authz-C3UU1LOA.js';
import { a as crearAutorizacionesDeSalida, e as editarSalida, b as obtenerSalida, d as listarAutorizacionesDeSalida } from './salidas-Boxs1Xl7.js';
...
var actions = {
	editar: async ({ request, locals, params }) => {
		if (!locals.usuario) throw redirect(303, "/auth");
		if (!await esPreceptorODirectivo(locals.usuario.usuarioId)) error(403, "No tenés permiso para editar salidas.");
		const id = parseInt(params.id, 10);
	...
	agregarAlumnos: async ({ request, locals, params }) => {
		if (!locals.usuario) throw redirect(303, "/auth");
		if (!await esPreceptorODirectivo(locals.usuario.usuarioId)) error(403, "No tenés permiso para modificar salidas.");
		const id = parseInt(params.id, 10);
		const fd = await request.formData();
		let alumnos = [];
		try {
...
const index = 27;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-DBgifYrq.js')).default;
const server_id = "src/routes/institucional/salidas/[id]/+page.server.ts";
const imports = ["_app/immutable/nodes/27.DqkLSLoK.js","_app/immutable/chunks/DW4Xyvmx.js","_app/immutable/chunks/KSMu1ZJk.js","_app/immutable/chunks/BJw1CIMz.js","_app/immutable/chunks/syVMyE1c.js","_app/immutable/chunks/Q94VlVm2.js","_app/immutable/chunks/CP-HLUA-.js"];
const stylesheets = ["_app/immutable/assets/27.D_DYosIW.css"];
const fonts = [];

export { component, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=27-S-uxHdQW.js.map

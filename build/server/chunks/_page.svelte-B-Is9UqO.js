import { R as head, U as attr, S as escape_html, V as attr_class, W as stringify } from './dev-BsNQnjV4.js';
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		if (salida.documentoPath || form?.ok) {
			$$renderer.push("<!--[0-->");
			$$renderer.push(`<div class="bg-green-50 border border-green-200 rounded-lg p-4 text-center"><p class="text-2xl mb-1">✅</p> <p class="text-sm font-semibold text-green-800">Documento recibido correctamente</p> <p class="text-xs text-green-600 mt-1">La autorización fue enviada al establecimiento. ¡Gracias!</p></div>`);
		} else {
			$$renderer.push("<!--[-1-->");
			if (form?.error) {
				$$renderer.push("<!--[0-->");
...
//# sourceMappingURL=_page.svelte-B-Is9UqO.js.map

...
import { o as obtenerAutorizacionPorToken, m as marcarAutorizacionSubida } from './salidas-Boxs1Xl7.js';
...
var actions = { subir: async ({ request, params }) => {
	...
	try {
		...
		return fail(413, { error: "El archivo es demasiado pesado. Intentá con una foto más liviana (máx. 10 MB)." });
	}
...
const imports = ["_app/immutable/nodes/17.B_HfjT46.js","_app/immutable/chunks/85pPpyzY.js","_app/immutable/chunks/BaKrtv6m.js","_app/immutable/chunks/DTVGdrrC.js"];
const stylesheets = [];
const fonts = [];

export { component, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=17-CepnhhhL.js.map

import { h as head, e as escape_html, b as attr } from './dev-B1vF67ZX.js';
	...
	$$renderer.component(($$renderer) => {
		...
		head("1s728sz", $$renderer, ($$renderer) => {
			$$renderer.title(($$renderer) => {
				$$renderer.push(`<title>Ingresar — Legajo</title>`);
			});
		});
		$$renderer.push(`<div class="min-h-screen bg-gray-50 flex items-center justify-center px-4"><div class="w-full max-w-sm"><div class="text-center mb-8"><div class="inline-flex items-center justify-center w-14 h-14 bg-indigo-600 rounded-2xl mb-4 shadow-lg"><span class="text-white text-2xl">📝</span></div> <h1 class="text-2xl font-bold text-gray-900">Legajo</h1> <p class="text-gray-500 text-sm mt-1">Registro docente</p></div> <div class="card"><form method="POST" action="?/login" class="space-y-4">`);
		if (form?.error) {
			$$renderer.push("<!--[0-->");
...
//# sourceMappingURL=_page.svelte-fuhJKKQp.js.map

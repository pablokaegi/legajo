...
<div class="space-y-4">
  <div class="flex items-center justify-between">
    ...
    <a href="/institucional/agrupamientos/nueva" class="btn-primary text-sm">+ Nueva</a>
  </div>
  ...
  {#if data.lista.length === 0}
    <div class="card text-center py-10">
      ...
      <a href="/institucional/agrupamientos/nueva" class="mt-3 inline-block text-sm text-indigo-600 hover:underline">
        Crear la primera
      </a>
    </div>
  ...
  {:else}
    <div class="space-y-2">
      {#each listaFiltrada as s}
        <a
          href="/institucional/agrupamientos/{s.id}"
